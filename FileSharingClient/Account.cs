...
namespace FileSharingClient
{
    public partial class Account : Form
    {
        ...
        // Using maxFileSize from configuration instead of hardcoded TOTAL_STORAGE_BYTES
        ...
        private async void LoadAccountInfo()
        {
            try
            {
                ...
                string totalStorage = FormatFileSize(maxFileSize);
                
                // Calculate percentage for progress bar
                double usagePercentage = (double)usedStorageBytes / maxFileSize * 100;
